...
export class LoginComponent{
  ...
  constructor(config: NgbModalConfig, private modalService: NgbModal, private _allService: AllServiceService,private matsnackbar: MatSnackBar , private router:Router) {
