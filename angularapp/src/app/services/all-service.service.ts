...
export class AllServiceService {
  ...
  async AccessProfile(): Promise<string> {
    ...
    // await this._httpClient.get(this._url+'gettoken' , { responseType: 'text'}).toPromise();
    this.id = await this._httpClient.get(this._url + 'gettoken', { responseType: 'text' }).toPromise();
    console.log(this.id);
